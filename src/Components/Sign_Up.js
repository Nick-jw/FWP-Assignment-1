                        ...
                        <div style={{margin:70}}>
                            <div className={"form-group row mx-auto"} style={{width:400}}>
                                ...
                                <form onSubmit={onSubmit}>
                                    <div>
                                        <label className={"col-sm-2 col-form-label h6"}>Username</label>
                                        <input className={"form-control"} type="text" value={username} onChange={onUserChange} />
                                    </div>
                                    <div>
                                        <label className={"col-sm-2 col-form-label h6"} for={"staticEmail"}>Email</label>
                                        <input className={"form-control"} type="email" value={email} onChange={onEmailChange} />
                                    </div>
                                    <div>
                                        <label className={"col-sm-2 col-form-label h6"}>Password</label>
                                        <input className={"form-control"} type="password" value={password} onChange={onPassChange} />
                                    </div>
